# bot.py – Full updated with global sites (admin only) + improved rotation + strict site quality
...
# FULL UPDATED SITE_ERROR_KEYWORDS WITH ALL DEAD RESPONSES (including additional error keywords)
SITE_ERROR_KEYWORDS = [
