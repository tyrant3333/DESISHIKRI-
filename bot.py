...
async def single_cc_check(event):
    ...
    try:
        ...
        async with get_user_sem(uid, "sp"):
            ...
            result, _, _ = await check_card_with_retry(card, sites, uid, max_retries=4, http_session=http_session)
            bi = await bin_task
...
# ====================== IMPROVED MASS PROCESSING FOR /msp (with detailed results file) ======================
