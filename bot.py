...
# FIX: Added NO_PRODUCT, NO_SESSION_TOKEN, TOKENIZATION_FAILED, PRICE_OVER_MAX to dead detection
...
SITE_ERROR_KEYWORDS = [
    ...
    # === ADDED MISSING SHOPIFY ERROR CODES (LOWERCASE) ===
    'site_requires_login',
    ...
    # === NEW FIX: NO_PRODUCT, NO_SESSION_TOKEN, TOKENIZATION_FAILED, PRICE_OVER_MAX ===
    'no_product',
    'no products found',
    'no_session_token',
    'tokenization_failed',
...
def is_site_truly_dead(response, price):
    ...
    exact_dead = [
        ...
        # === ADDED MISSING SHOPIFY ERROR CODES (UPPERCASE) ===
        'SITE_REQUIRES_LOGIN',
        'NO_SHOPIFY_PAYMENTS_GATEWAY',
        'NO_PRODUCT',
        'TOKENIZATION_FAILED',
    ...
    dead_indicators = [
        ...
        # === ADDED MISSING LOWERCASE VARIANTS ===
        'site_requires_login',
        'no_shopify_payments_gateway',
        'no_shopify_payment_gateway',
        'no_product',
...
async def test_site(site, proxy_data=None, http_session=None):
    ...
    try:
        ...
        # Early detection for known dead error codes (added)
        if rm and rm.upper().startswith(('SITE_', 'NO_', 'CHECKOUT_', 'MERCHANDISE_', 'TOKENIZATION_', 'CART_', 'PRICE_OVER_MAX')):
