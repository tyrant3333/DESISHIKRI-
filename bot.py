...
HIT_BUTTON = [[Button.url(bs("TyrantProX"), "https://t.me/PussyShopifybot")]]
...
SITE_ERROR_KEYWORDS = [
   ...
   'site_requires_login',
    ...
    # Add any other missing lowercase variants
]
...
def is_site_truly_dead(response, price):
    ...
    exact_dead = [
        ...
        'TOKENIZATION_FAILED',
        'CART_FAILED',
    # Add any other exact uppercase error codes (see complete list below)
]
        'PRODUCT_NOT_AVAILABLE_IN_QUANTITY',
        'INVALID_SHIPPING_ADDRESS',
        'INVALID_BILLING_ADDRESS',
